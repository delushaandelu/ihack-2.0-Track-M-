                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                                ...
                                <td><center><Button type='submit' class='btn btn-danger'><i class='fa fa-trash-o' aria-hidden='true'></i></button><Button type='submit' class='btn btn-success'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></button></center></td>
